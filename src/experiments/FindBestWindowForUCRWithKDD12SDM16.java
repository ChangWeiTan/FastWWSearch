 ...
 *
 */
public class FindBestWindowForUCRWithKDD12SDM16 {
	...
	public static void main(String[] args) throws Exception {
		...
		type = "kdd12sdm16";			// Method type in finding the best window
	...
	private static void singleProblem (String datasetName) throws Exception {
        ...
        for (int i = 0; i < nbRuns; i++) {
        	...
        	System.out.println("Run " + i + ", Launching KDD12 + SDM16");
        	KDD12SDM16 classifier = new KDD12SDM16(datasetName);
