...
import windowSearcher.FastWWSWithPrunedDTW;
import weka.classifiers.Evaluation;
import weka.core.Instances;

public class IncorporatingSDM16ToFastWWS {
	private static String osName, datasetName, username, projectPath, datasetPath, resDir, sampleType, type;
	...
	public static void main(String[] args) throws Exception {
		...
		if (sampleType.equals("Single") && args.length >= 4) datasetName = args[3];
	...
	private static void singleProblem (String datasetName) throws Exception {
        ...
        for (int i = 0; i < nbRuns; i++) {
        	...
        	FastWWSWithPrunedDTW fastwwsSDM16Classifier = new FastWWSWithPrunedDTW(datasetName);
        	fastwwsSDM16Classifier.setResDir(resDir);
        	fastwwsSDM16Classifier.setType(type);
	...
	private static void saveSearchTime(double searchTime, double error) {
		String fileName = resDir + datasetName + "_result_" + type + ".csv";
		FileWriter out;
