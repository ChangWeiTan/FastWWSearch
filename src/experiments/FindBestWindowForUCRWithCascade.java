...
import windowSearcher.CascadeLB;
 ...
 *
 */
public class FindBestWindowForUCRWithCascade {
	...
	public static void main(String[] args) throws Exception {
		...
		type = "kdd12";					// Method type in finding the best window
		...
		System.out.println("Find best warping window with " + sampleType + " dataset");
	...
	private static void singleProblem (String datasetName) throws Exception {
     ...
     // Go through different runs and randomize the dataset
        for (int i = 0; i < nbRuns; i++) {
        	...
        	System.out.println("Run " + i + ", Launching KDD12");
        	CascadeLB classifier = new CascadeLB(datasetName);
