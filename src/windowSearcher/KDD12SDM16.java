...
import items.LazyCascadingLBEarlyAbandon;
import items.LazyCascadingLBEarlyAbandon.RefineReturnType;
...
import windowSearcher.KDD12SDM16;
 ...
 *
 */
public class KDD12SDM16 extends WindowSearcher {
	// --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
    // Fields
    // --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
	...
	private LazyCascadingLBEarlyAbandon[][] lazyUCR;		// LazyUCR distance with Early Abandon
	...
	public void buildClassifier(Instances data) throws Exception {
		...
		lazyUCR = new LazyCascadingLBEarlyAbandon[train.length][train.length];
		
		for (int i = 0; i < train.length; i++) {
			for (int j  = 0; j < train.length; j++) {
				lazyUCR[i][j] = new LazyCascadingLBEarlyAbandon(cache);
			}
		}
